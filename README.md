...
3. 양 한 마리가 배부르면 UFO가 실제 위치에서 회수합니다. 패널은 즉시 다음 번호의 배고픈 양을 `INBOUND · 0/20`으로 예고하고, UFO는 0.104초 동안 화면 안을 실제로 빠르게 가로질러 도착 광원을 번쩍입니다. 새 양은 비행에 실리지 않고 그 목적지 칸에서만 나타납니다.
...
- 장거리 초기 투입은 이동 거리에 맞춰 여유 있게 비행하고, 교대 UFO는 기존 스트릭과 도착 광원을 쓰는 0.104초 속도 이동
