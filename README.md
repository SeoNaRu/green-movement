...
3. 양 한 마리가 배부르면 UFO가 실제 위치에서 회수합니다. 패널은 즉시 다음 번호의 배고픈 양을 `INBOUND · 0/20`으로 예고하고, UFO는 짧게 출발한 뒤 초록빛으로 점멸하고 목적지 직전에 다시 나타나 정확히 멈춥니다. 수거된 양과 새 양은 서로 다른 개체이며, 새 양은 비행에 실리지 않고 그 목적지 칸에서만 나타납니다.
...
- 수거 직후 패널에서 다음 양의 새 번호와 `INBOUND · 0/20`을 먼저 보여 주고, 로스터 번호마다 별도 SVG 개체인 깨끗한 흰색·빈 포만도의 새 양을 목적지 칸에서만 생성
