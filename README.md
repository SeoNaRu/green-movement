...
3. 양 한 마리가 배부르면 UFO가 회수하고, 잠깐 빈 자리를 보여 준 뒤 번호가 다른 배고픈 양을 내려 교대시킵니다.
4. 하단 작전 패널은 현재 양의 상태와 포만도, 전체 양 떼와 잔디 진행률을 실시간으로 보여 줍니다.
5. 마지막에도 먼저 먹은 양부터 UFO가 바로 수거하고, 모두 떠난 뒤 중앙 파동으로 GitHub 아이디를 남깁니다.

## 주요 특징

- 잔디 에너지에 따라 필드 인원을 1·2·4·6마리로 조절하고, 포만 즉시 교대
- 최대 마리 수 제한 없이 모든 양을 두 줄 작전 패널에 표시
