...
3. 양 한 마리가 배부르면 UFO가 실제 위치에서 회수합니다. 패널은 즉시 다음 번호의 배고픈 양을 `INBOUND · 0/20`으로 예고하고, UFO는 화면 안에서 떨어진 작업 구역까지 연속 비행한 뒤 그 양을 착지시켜 수거된 양과 새 양을 분명히 구분합니다.
...
- 장거리 초기 투입은 이동 거리에 맞춰 여유 있게 비행하고, 교대 때는 UFO를 숨기거나 순간이동시키지 않고 다른 위치까지 연속 비행
- 수거 직후 패널에서 다음 양의 새 번호와 `INBOUND · 0/20`을 먼저 보여 주고, 착지 뒤 잠깐 함께 멈춘 다음 UFO가 출발
- 수거·투입 지점을 화면상 UFO 폭보다 멀리 분리하고, 새 양은 착륙 뒤 기존 한 칸 속도로 다음 잔디까지 이동
