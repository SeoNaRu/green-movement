...
3. 양 한 마리가 배부르면 UFO가 실제 위치에서 회수하고 위로 사라집니다. 이어 떨어진 작업 구역 위에서 다시 나타나 번호가 다른 배고픈 양을 내려 주므로, 한 양을 그대로 옮기는 대신 실제 교대로 읽힙니다.
...
- 장거리 초기 투입은 이동 거리에 맞춰 여유 있게 비행하고, 교대 때는 수거 장면을 끝낸 뒤 다른 위치에서 새 양을 정면 착지
