...
3. 양 한 마리가 배부르면 UFO가 실제 위치에서 회수합니다. 패널은 즉시 다음 번호의 배고픈 양을 `INBOUND · 0/20`으로 예고하고, UFO는 짧게 출발한 뒤 초록빛으로 점멸하고 목적지 직전에 다시 나타나 정확히 멈춥니다. 새 양은 비행에 실리지 않고 그 목적지 칸에서만 나타납니다.
...
- 첫 UFO부터 배치·교대·수거·마지막 중앙 집결·퇴장까지 최대 12px의 짧은 출발과 도착 움직임 사이를 같은 초록빛 점멸로 연결
- 일반 배치와 수거 이동은 화면에서 0.156초, 교대는 0.104초에 끝나며, 본체가 숨은 중간에도 기존 초록빛이 이동 방향을 이어 줌
- 수거 직후 패널에서 다음 양의 새 번호와 `INBOUND · 0/20`을 먼저 보여 주고, 깨끗한 흰색·빈 포만도의 새 양을 목적지 칸에서만 생성
- 수거·투입 지점을 화면상 UFO 폭보다 멀리 분리하고, 새 양은 그 자리에서만 나타남. 초기 투입 양도 UFO가 출발하기 전에는 착지 칸을 벗어나지 않음
